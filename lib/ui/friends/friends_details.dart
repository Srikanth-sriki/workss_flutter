...
class FriendsDetailsScreen extends StatefulWidget {
  ...
  final String id;
  const FriendsDetailsScreen({super.key, required this.refreshPageCallback,required this.id});
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              image:  DecorationImage(
                                                image: NetworkImage(
                                                  friendView.profilePic, // Replace with actual profilePic
                                                ),
                                                fit: BoxFit.cover,
                                              ),
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            registerTextCard(
                                                text:
                                                friendView.knownLanguages!.join(", "),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            capitalizeEachWord(friendView.chargeType),
                                            style: TextStyle(
                                              color: COLORS.neutralDarkOne,
                                      ...
                                      TouchRippleEffect(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            child: Text(
                                                friendView.isFriend != null?'UNFRIEND'.tr():'ADD FRIEND',
                                              style: TextStyle(
                                                color: COLORS.primary,
                      ...
                      delegate: SliverChildBuilderDelegate((context, index) {
                        return Padding(
                          ...
                          child: friendSearchDetailsCards(
                              image: friendList[index].friends.profilePic,
                              name: friendList[index].friends.name,
                              onTapCard: () {
                                // Navigator.push(
                                //   context,
                                //   MaterialPageRoute(
                              ...
                              disc: friendList[index].friends.professionType,),
                        );
                      },
